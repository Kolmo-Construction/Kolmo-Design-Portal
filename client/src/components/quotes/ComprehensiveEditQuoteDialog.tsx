...
interface ComprehensiveEditQuoteDialogProps {
  quote: QuoteWithDetails;
  open: boolean;
  onOpenChange: (open: boolean) => void;
}

export function ComprehensiveEditQuoteDialog({ quote, open, onOpenChange }: ComprehensiveEditQuoteDialogProps) {
              ...
              <CardContent className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-4">
                    ...
                    <Button
                      onClick={() => updateQuoteMutation.mutate({ ...formData, ...financialData })}
                      disabled={updateQuoteMutation.isPending}
                      className="w-full"
                    >
                      {updateQuoteMutation.isPending ? "Updating..." : "Update Financials"}
                    </Button>
                  </div>
              ...
              <CardContent className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div className="md:col-span-3 flex justify-end">
                  <Button
                    ...
                    disabled={updateQuoteMutation.isPending}
                  >
                    {updateQuoteMutation.isPending ? "Updating..." : "Update Payment Schedule"}
                  </Button>
                </div>
              </CardContent>
            </Card>
